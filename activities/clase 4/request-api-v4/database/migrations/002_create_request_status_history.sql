...
CREATE TABLE request_status_history (
  ...
  -- NULL means the request was just born — there was no previous status.
  ...
  -- Because every event must result in a concrete status; a birth always
  -- produces 'open' and a transition always lands somewhere.
